...
export default function Hero() {
  ...
  return (
    <section id="about" className="relative flex items-center justify-center px-6 md:px-20 py-20 md:py-32 overflow-hidden bg-[#020202]">
      
      {/* --- MINIMIZED BUT VIBRANT GLOWS --- */}
      {/* Cyan: Reduced size/opacity, but kept the vibrant hue */}
      <div className="absolute top-0 left-0 w-[30%] h-[30%] rounded-full bg-[#00f2ff] opacity-[0.1] blur-[120px] pointer-events-none animate-float" />
      
      {/* Pink/Purple: Large but deep, providing the "Black & Color" atmosphere */}
      <div className="absolute bottom-[-5%] right-[-5%] w-[60%] h-[60%] rounded-full bg-[#bc13fe] opacity-[0.12] blur-[140px] pointer-events-none animate-float" style={{ animationDelay: '-3s' }} />
